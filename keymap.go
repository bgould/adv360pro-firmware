...
func initKeymap() keyboard.Keymap {
	return keyboard.Keymap([]keyboard.Layer{
		...
		kinadv360pro.Layer(
			...
			/* */ KC_TAB_, KC_Q___, KC_W___, KC_E___, KC_R___, KC_T___, KC_F1__, /* */
			/* */ KC_RCTL, KC_A___, KC_S___, KC_D___, KC_F___, KC_G___, KC_F2__, /* */
			...
			/* ****************************** *\/* ******************************** */
			/* */ KC_FN2_, KC_N6__, KC_N7__, KC_N8__, KC_N9__, KC_N0__, KC_MINS, /* */
			/* */ KC_F5__, KC_Y___, KC_U___, KC_I___, KC_O___, KC_P___, KC_BSLS, /* */
			/* */ KC_PSCR, KC_H___, KC_J___, KC_K___, KC_L___, KC_SCLN, KC_QUOT, /* */
			/* *\       */ KC_N___, KC_M___, KC_COMM, KC_DOT_, KC_SLSH, KC_RSFT, /* */
			/* *\                */ KC_UP__, KC_DOWN, KC_LBRC, KC_RBRC, KC_FN1_, /* */
			/* */ KC_LALT, KC_LCTL, /*                                           /* */
			/* */ KC_PGUP, /*                                                    /* */
		...
		kinadv360pro.Layer(
			...
			/* */ KC_FN1_, _______, _______, _______, _______, /*                /* */
			/* *\                                           */ _______, _______, /* */
			/* *\                                                    */ _______, /* */
			/* *\                                  */ _______, _______, _______, /* */
			/* ****************************** *\/* ******************************** */
			/* */ KC_FN2_, KC_F7__, KC_F8__, KC_F9__, KC_F10_, KC_F11_, KC_F12_, /* */
			/* */ _______, _______, _______, _______, _______, _______, _______, /* */
			/* */ _______, _______, _______, _______, _______, _______, _______, /* */
			/* *\       */ _______, _______, _______, _______, _______, _______, /* */
			/* *\                */ _______, _______, _______, _______, KC_FN1_, /* */
			/* */ _______, _______, /*                                           /* */
			/* */ _______, /*                                                    /* */
			/* */ _______, _______, _______, /*                                  /* */
			/* ****************************** *\/* ******************************** */
		...
		kinadv360pro.Layer(
			...
			/* */ _______, _______, _______, _______, _______, _______, _______, /* */
			/* */ _______, _______, _______, _______, _______, _______, KC_FN0_, /* */
			/* */ _______, _______, _______, _______, _______, _______, /*       /* */
			...
			/* *\                                  */ _______, _______, _______, /* */
			/* ****************************** *\/* ******************************** */
			/* */ KC_FN2_, _______, _______, _______, _______, _______, _______, /* */
			/* */ _______, _______, _______, _______, _______, _______, _______, /* */
			/* */ KC_FN0_, _______, _______, _______, _______, _______, _______, /* */
			/* *\       */ _______, _______, _______, _______, _______, _______, /* */
			/* *\                */ _______, _______, _______, _______, _______, /* */
			/* */ _______, _______, /*                                           /* */
			/* */ _______, /*                                                    /* */
